...
<body>
    <div class="container">
        <div class="form-princ">
            <form action="../Controlador/Nave4.php" method="POST">
                <div class="pagina">
                    <div class="titulo">Crear nave 4</div>
                    <br>
                    <div class="row">
                        <div class="col-6">
                        ...
                        <div class="col-6">
                            ...
                            <input type="text" class="form-control" type="text" id="destino" name="destino" value="">
                        </div>
