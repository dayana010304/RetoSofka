...
<body>
    <div class="container">
        <div class="form-princ">
            <form action="../Controlador/Nave1.php" method="POST">
                <div class="pagina">
                    <div class="titulo">Crear nave 1</div>
                    <br>
                    <div class="row">
                        <div class="col-6">
                        ...
                        <div class="col-6">
                            ...
                            <input type="text" class="form-control" type="text" id="origen" name="origen" required>
                        </div>
